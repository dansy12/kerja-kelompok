    ...
    <body>
     ...
     <div class="navbar-fixed">
        <nav class="red darken-2">
          <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
              ...
              <li><a class="waves-effect waves-light btn white red-text" href="signup.jsp">Sign Up</a></li>
            </ul>
          </div>
        </nav>
      </div>
      ...
      <ul class="sidenav center" id="mobile-nav">
            <li><a class="waves-effect waves-light red white-text" href="login.jsp">Sign In</a></li>
            <li><a class="waves-effect waves-light white red-text" href="signup.jsp">Sign Up</a></li>
      </ul>


      <!-- Form Login -->
      <section id="login" class="login grey lighten-4">
        <form method="post" action="signupproses.jsp">
            <div class="row">
              <div class="col s12 m4 offset-m4">
                <div class="card-panel center satu">
                  ...
                  <div class="input-field">
                    <input type="text" name="notlp" id="text" required class="validate">
                    <label for="text">No.Telpon</label>
                  </div>
                  <input type="submit" class="waves-effect waves-light btn white red-text submit" value="Submit" />
                  <input type="reset" class="waves-effect waves-light btn red white-text cancel" value="Reset" />
                </div>
              </div>
            </div>
        </form>
